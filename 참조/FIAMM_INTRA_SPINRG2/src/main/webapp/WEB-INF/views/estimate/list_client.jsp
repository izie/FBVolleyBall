...
try{
	...
	Vector vecClient = cDAO.getClient("¸ÅÃâ");
	cDAO.closeAll();
%>
...
function sel_item( item_num,seq_client ){
	...
	sel_stat = item_num;
	chg_color();
	parent.iframe1.location='list_origin.jsp?seq_client='+seq_client;
}
function chg_color(){
...
<tr height=20>
	...
	<td class="bk2_1"><a id="a<%=i%>" style="cursor:hand;" onclick="sel_item('a<%=i%>','<%=cl.seq%>')"><%=cl.bizName%></a></td>
</tr>
<%	}//for	%>
</table>
</BODY>
