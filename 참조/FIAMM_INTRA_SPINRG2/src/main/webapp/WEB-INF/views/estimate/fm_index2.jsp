...
function inputData(){
	...
	var ofrm = opener.document.frmPrjAdd;
...
<tr>
	<td class="tableoutLine" width="50%"><iframe id="iframe0" src="fm0_client_list2.jsp?seq_client=<%=seq_client%>" width="100%" height="100%" frameborder="0"></iframe></td>
