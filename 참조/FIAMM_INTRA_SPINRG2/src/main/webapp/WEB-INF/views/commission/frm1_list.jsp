...
<table cellpadding="0" cellspacing="1" border="0" width="100%" id="id_tb">
...
<SCRIPT LANGUAGE="JavaScript">
document.all.id_tb.style.width = document.body.clientWidth;
</SCRIPT>
