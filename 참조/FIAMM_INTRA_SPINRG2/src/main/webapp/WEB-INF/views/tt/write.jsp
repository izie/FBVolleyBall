...
<tr>
	...
	<td class="bk2_1">&nbsp;
		<INPUT TYPE="text" NAME="invoNum" maxlength=200 style="width:90%" class="inputbox1" value=""></td>
	<td class="bk1_1" align=right>Invoice Date:</td>
	<td class="bk2_1">&nbsp;
		<INPUT TYPE="text" NAME="invoDate" maxlength=8 size=8 class="inputbox1" value="" onblur="DateAdd()"></td>
</tr>
<tr valign=top>
	...
	<td class="bk2_1">&nbsp;
		...
		<INPUT TYPE="text" NAME="price" maxlength=20 size=20 class="inputbox1" onkeyup="commaFlag()" value="">
		
		<div id="id_k1" style="display:none">&nbsp;
			화폐단위: <input type="text" name="priceKinds" value="\" class="inputbox1" maxlength="30" size="10"></div></td>
	
	
	<td class="bk1_1" align=right bgcolor="#f7f7f7">TT 만기일:</td>
	<td class="bk2_1">&nbsp;
		<INPUT TYPE="text" NAME="limitDate" maxlength=8 size=8 class="inputbox1" value=""></td>
</tr>
<tr>
	<td class="bk1_1" align=right>결제일:</td>
	<td class="bk2_1">&nbsp;
		<INPUT TYPE="text" NAME="payDate" maxlength=8 size=8 class="inputbox" value=""></td>
	<td class="bk1_1" align=right>은행명:</td>
	<td class="bk2_1">&nbsp;
		<INPUT TYPE="text" NAME="bankName" maxlength=50 size=8 class="inputbox" value="">
...
<form name='dataform'>
<textarea name="priceKinds" style="display:none"><%=KUtil.nchk(po.priceKinds)%></textarea>
<textarea name="price" style="display:none"><%=po.poTotPrice>0?po.poTotPrice+"":""%></textarea>
</form>
</table>
<SCRIPT LANGUAGE="JavaScript">
...
var flg = 0;
for( var i=0 ; i<ofrm._priceKinds.length ; i++ ){
	if( ofrm._priceKinds.options[i].value==frm.priceKinds.value ){
		ofrm._priceKinds.options[i].selected = true;
		flg = 1;
	}
}
if( flg == 0 ){
	for( var i=0 ; i<ofrm._priceKinds.length ; i++ ){
		if( ofrm._priceKinds.value=='0' ){
			ofrm._priceKinds.options[i].selected = true;
		}
	}
	changePriceKinds();
...
ofrm.price.value = frm.price.value;
commaFlag();
</SCRIPT>	
<%	}//if
}catch(Exception e){
