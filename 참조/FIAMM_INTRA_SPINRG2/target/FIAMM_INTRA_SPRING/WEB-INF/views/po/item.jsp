...
function itemLenView(){
	...
	lenObj.innerHTML = "PO품목: <b><font color='#660000'>"+len+"</font></b> 개";
}
</SCRIPT>
</HEAD>
...
<tr>
	<td width="300" class="tdAllLine">
		<iframe id="iframe0" src="item_fm0_list.jsp" width="100%" height="200" frameborder="0"></iframe></td>
	<td width="300" class="tdAllLine">
		<iframe id="iframe1" width="100%" height="200" frameborder="0"></iframe></td>
</tr>
...
<tr>
	<td colspan=2 class="tdAllLine">
		<iframe id="iframe2" width="100%" height="400" frameborder="0"></iframe></td>
</tr>
</form>
</table>
</BODY>
