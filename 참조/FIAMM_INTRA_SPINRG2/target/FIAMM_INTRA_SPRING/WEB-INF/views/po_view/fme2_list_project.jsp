...
try{ 
	...
	Project pj = pjDAO.selectOne(seq_project);
%>
...
function opWin(seq){
	...
	var opt = window.open("/main/project/view.jsp?seq="+seq,"viEsti","width=720,height=600,left="+lft+",top=0,scrollbars=1");
}
var sel_stat = "";
...
<%	if( pj.seq > 0 ){	%>
	...
	<a id="a" style="cursor:hand;" onclick="sel_item('a','<%=pj.seq%>')"><%=pj.name%></a></div>
<%	}else{	%>
<div>프로젝트가 없습니다.</div>
<%	}	%>	
	</td>
